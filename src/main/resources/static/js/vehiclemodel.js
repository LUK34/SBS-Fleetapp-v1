...
{
/* ----------------------------- vehiclemodel.html-> "EditButton" when this icon is clicked logic START -------------------------------------- */
...
/* ----------------------------- vehiclemodel.html-> "EditButton" when this icon is clicked logic END -------------------------------------- */




/* ----------------------------- vehiclemodel.html-> "ViewButton" icon when this icon is clicked logic START -------------------------------------- */
...
/* ----------------------------- vehiclemodel.html-> "ViewButton" icon when this icon is clicked logic END -------------------------------------- */


   
/* ----------------------------- vehiclemodelmake.html-> "DeleteButton" icon when this icon is clicked logic START -------------------------------------- */   
